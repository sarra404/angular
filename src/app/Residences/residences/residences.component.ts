...
export class ResidencesComponent {
  listResidences:Residence[]=[
    ...
    "address":"Ezzahra","image":"../../assets/img/chameleon-6159370_640.jpg", status:
    "Disponible" },
    {id:3,"name": "El Arij",
    "address":"Rades","image":"../../assets/img/chameleon-6159370_640.jpg", status:
    "Vendu"},
    {id:4,"name": "El Anber","address":"inconnu",
    "image":"../../assets/img/chameleon-6159370_640.jpg", status: "En Construction"}
    ];
